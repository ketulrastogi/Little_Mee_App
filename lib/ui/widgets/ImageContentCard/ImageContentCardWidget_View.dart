...
import 'package:little_mee/ui/widgets/ImageContentCard/ImageContentCardWidgetView_ViewModel.dart';
      ...
      builder: (context, model, child) {
        return Card(
          child: InteractiveViewer(
            child: Image.network(
                'https://physics.aps.org/assets/bb70290a-ab2a-45ba-9040-6053a1e15d60/e24_1.png'),
          ),
        );
      },
    );
